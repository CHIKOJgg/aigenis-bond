...
def orm_to_bond(b: BondORM) -> Bond:
    return Bond(
        ...
        bid=b.bid,
        ask=b.ask,
        bid_yield=b.bid_yield,
        ask_yield=b.ask_yield,
...
def bond_facts(b: Bond) -> dict:
    return {
        ...
        "bid": float(b.bid) if b.bid else None,
        "ask": float(b.ask) if b.ask else None,
        "bid_yield": float(b.bid_yield) if b.bid_yield else None,
        "ask_yield": float(b.ask_yield) if b.ask_yield else None,
