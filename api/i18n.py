...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "invalid_url": "URL webhook должен начинаться с https://",
        ...
        "partner_request_submitted": "Заявка получена. Мы свяжемся с вами в ближайшее время.",
    },
    "en": {
        ...
        "invalid_url": "Webhook URL must start with https://",
        ...
        "partner_request_submitted": "Request received. We will contact you shortly.",
    },
    "kz": {
        ...
        "invalid_url": "Webhook URL https:// басталуы керек",
        ...
        "partner_request_submitted": "Сұрау қабылданды. Біз сізге жақын арада хабарласамыз.",
    },
}
