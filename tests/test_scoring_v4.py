...
class TestEfficiencyRatio:
    def test_good_bond_efficiency(self):
        bd = ScoreBreakdown(
            yield_component=15,
            currency_component=20,
            duration_component=7,
            liquidity_component=11,
            credit_risk_component=12,
            inflation_component=6,
            coupon_component=4,
            historical_volatility_component=3,
    ...
    def test_risky_bond_low_efficiency(self):
        bd = ScoreBreakdown(
            yield_component=3,
            currency_component=0,
            duration_component=-3,
            liquidity_component=0,
            credit_risk_component=-28,
            inflation_component=-2,
